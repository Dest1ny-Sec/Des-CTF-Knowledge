...
A = sys_numberA >=0x40000000? dead :nextA == execve ? dead :nextA ==open? dead :nextA == openat ? dead :nextA == execveat ? dead :nextA == mmap ? dead :nextA == fstat ? dead :nextreturnALLOWdead:returnKILL
...
__int64 __fastcallconnMngr(constchar*Invalid_option._Please_try_again., __int64 a2){ __int64 result;// raxwhile(1) {connMngrMenu(); result = (unsignedint)readint(Invalid_option._Please_try_again., a2);switch( (int)result ) {case1:addConn(); //addbreak;case2:removeConn(); //deletbreak;case3:editConn(); //editbreak;case4:listConn(); //showbreak;case5:returnresult;default: Invalid_option._Please_try_again. ="Invalid option. Please try again.";puts("Invalid option. Please try again.");break; } }}
